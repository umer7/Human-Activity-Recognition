...
The scripts have been solely produced, tested and executed on Windows 7 Ultimate and RStudio Version 0.99.486.  
Developer: <b>Umer Farooq</b>  
GitHub Repo: [<https://github.com/umer7/Human-Activity-Recognition>](https://github.com/umer7/Human-Activity-Recognition)  
...
``` r
setwd("~/GitHub/Human-Activity-Recognition")
```
